...
```yaml
name       : Shivam
role       : Cybersecurity Engineer | Ethical Hacker | Secure AI Builder
focus      : Adversarial Security — Offensive • Defensive • Intelligent Systems
method     : Failure Analysis → Structural Hardening
philosophy : "Understand everything. Break what must be broken. Build what must survive."
status     : Continuous Research
```

> I don't chase vulnerabilities.
> I study **why** they exist — the trust boundaries, hidden assumptions, and failure paths baked into architecture.
> Anything built can be understood. Anything understood can be broken — or made resilient.
...
| Parameter | Value |
|-----------|-------|
| **Field** | Cybersecurity Engineering & Ethical Hacking |
| **Core Focus** | Trust • Identity • System Behavior |
| **Target** | Hidden Weaknesses in Architecture |
| **Method** | Failure Analysis → Defensive Design |
| **Stack** | Linux • Web • AI/ML |
...
![Bash](https://img.shields.io/badge/Bash-0D1117?style=for-the-badge&logo=gnu-bash&logoColor=00F0FF)
![HTML5](https://img.shields.io/badge/HTML5-0D1117?style=for-the-badge&logo=html5&logoColor=00F0FF)
...
![Nmap](https://img.shields.io/badge/Nmap-0D1117?style=for-the-badge&logo=nmap&logoColor=00F0FF)
![Wireshark](https://img.shields.io/badge/Wireshark-0D1117?style=for-the-badge&logo=wireshark&logoColor=00F0FF)
...
![Git](https://img.shields.io/badge/Git-0D1117?style=for-the-badge&logo=git&logoColor=00F0FF)
...
![Raspberry Pi](https://img.shields.io/badge/Raspberry_Pi-0D1117?style=for-the-badge&logo=raspberrypi&logoColor=00F0FF)
![VS Code](https://img.shields.io/badge/VS_Code-0D1117?style=for-the-badge&logo=visualstudiocode&logoColor=00F0FF)
